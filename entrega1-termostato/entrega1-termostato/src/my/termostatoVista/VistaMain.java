...
public class VistaMain extends javax.swing.JFrame {
    ...
    public VistaMain() {
        initComponents();
        modelo=new ModeloNA();
        control=new ControladorNA(this,modelo);
        
        hora.setText(obtenerHora());
    ...
    private void initComponents() {
        ...
        boxPrograma.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Programa 0", "Programa 1", "Programa 2" }));
    ...
    private void numeroSemana(){
        ...
        cal.setTime(fecha);
        int numero = cal.get(Calendar.DAY_OF_WEEK);
     ...
     */
     public void setTemperaturas(){
         setTempMinima(modelo.getTemperaturas(obtenerPrograma())[0]);
         setTempMaxima(modelo.getTemperaturas(obtenerPrograma())[1]);
     }
    ...
    public void cambiarMenusHoras() {
       ArrayList <Boolean> resultado=modelo.getLista(obtenerPrograma());
